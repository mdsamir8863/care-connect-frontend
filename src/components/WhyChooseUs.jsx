    ...
    return (
        <div className="why-choose-us">
            <div className="text-section">
                ...
                <h2>Why Choose Us</h2>
                <p>
                    At Care Connect Medical Institute, we understand the importance of quality Care Connect. Here are a few reasons why you should choose us for your medical needs.
                </p>
